// ============================================================
//  src/components/ContextMenu.js — CrypView V2.7.2
...
//      onAddAlert:        (clientY) => alertManager.add(...),
//      onManageAlerts:    () => alertListModal.open(),  // ← v2.7.2
//    });
...
export class ContextMenu {
   ...
   * @param {function}         [callbacks.onManageAlerts]   — ouvre la liste des alertes
